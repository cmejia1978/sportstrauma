<div class="remodal remodal-lg" data-remodal-id="add-appointment-file"
        data-remodal-options="hashTracking: false">
    <button data-remodal-action="close" class="remodal-close"></button>


    <h4><strong>Agregar archivo(s)</strong></h4>
    <form id="appointment-file-upload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">

...
<div class="form-group description-group">
    <label class="control-label" for="input-oprecord-file-description">Descripción <span class="required">*</span>
    </label>
    <input type="text" id="input-oprecord-file-description" name="description" class="form-control" value="{{ $file->description }}">

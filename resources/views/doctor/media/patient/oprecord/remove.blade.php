<div class="remodal" data-remodal-id="remove-oprecord-file" data-remodal-options="hashTracking: false">
    <button data-remodal-action="close" class="remodal-close"></button>
    <form id="remove-oprecord-file-form" role="form">
        <h4><strong>Eliminar archivo</strong></h4>
        <input type="hidden" value="" name="fid" id="remove-oprecord-fid">

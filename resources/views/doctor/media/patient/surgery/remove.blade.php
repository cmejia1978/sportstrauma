<div class="remodal" data-remodal-id="remove-surgery-file" data-remodal-options="hashTracking: false">
    <button data-remodal-action="close" class="remodal-close"></button>
    <form id="remove-surgery-file-form" role="form">
        <h4><strong>Eliminar archivo</strong></h4>
        <input type="hidden" value="" name="fid" id="remove-surgery-fid">

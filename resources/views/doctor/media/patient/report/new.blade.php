<div class="remodal remodal-lg" data-remodal-id="add-report-file"
        data-remodal-options="hashTracking: false">
    <button data-remodal-action="close" class="remodal-close"></button>
    <h4><strong>Agregar archivo(s)</strong></h4>
    <form id="report-file-upload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">

...
<div class="form-group description-group">
    <label class="control-label" for="input-report-file-description">Descripción <span class="required">*</span>
    </label>
    <input type="text" id="input-report-file-description" name="description" class="form-control" value="{{ $file->description }}">

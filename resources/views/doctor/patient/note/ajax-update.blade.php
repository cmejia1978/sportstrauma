<h4><strong>Editar nota</strong></h4>
<input type="hidden" value="{{ $note->id }}" name="nid">
<div class="form-group description-group">
    <label class="control-label" for="input-description">Descripción <span class="required">*</span>
    </label>
    <textarea id="input-description" name="description" class="form-control" cols="30" rows="5">{{ $note->description }}</textarea>

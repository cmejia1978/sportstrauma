...
<head><meta charset="gb18030">
    <title>Actualizaci贸n Cita</title>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="font-size: 32px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy">Actualizaci贸n cita</td>
                            </tr>
                            <tr>
                                <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Se ha actualizado una cita para el <strong>{{ $appointment->start_date_time_fancy }}</strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <tr>
        <td bgcolor="#ffffff" align="center" style="padding: 20px 0px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;" class="responsive-table">
                ...
                <tr>
                    <td align="center" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#231E2D;">
                        Esta es una notificaci贸n, por favor no responder.<br>This is a notification, please do not reply.
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>

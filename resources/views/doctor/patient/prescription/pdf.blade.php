...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <base href="{{ url('/') }}">
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset('assets/css/pdf_hs.css') }}" />
    ...
    <table class="page-header-content">
        <tr>
            <td class="page-header-logo" valign="top">
                ...
                <div class="text-center" style="font-size: 12px; line-height: 1; color: #3CA2B8;">
                    <span>Cirugía Atroscópica y Traumatología Deportiva</span><br>Reconstrucción de Hombro, Codo y Rodilla</span>
                </div>
            </td>
            <td class="page-header-text" style="font-size: 12px;">
                <strong>Dr. Luis Pedro Carranza Sánchez</strong><br>
                <div style="font-size: 12px;">
                    <span>Traumatólogo y Ortopedista</span><br>
                    <span style="text-align: justify !important;">Fellowship en Traumatología Deportiva, Reconstrucción de Hombro, Codo y Rodilla, Universidad de Montreal, Canadá</span>
                </div>
            </td>
        </tr>
    </table>

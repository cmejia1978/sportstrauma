...
return [
    ...
    */
    'columns' => [
        'alpha'    => [
            'rows' => ['description', 'email', 'name', 'slug', 'first_name', 'middle_name', 'last_name', 'marital_status'],
        ...
        'numeric'  => [
            'rows' => ['created_at', 'updated_at', 'level', 'id', 'phone_number', 'social_sec_num'],
